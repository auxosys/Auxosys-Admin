...
const EditJob = () => {
  ...
  const [form, setForm] = useState({
    ...
    closing_date: "", short_summary: "", description: "", responsibilities: "", requirements: "",
    preferred_qualifications: "", nice_to_have: "", tech_skills: [], soft_skills: [],
    ...
    homepage_highlight: false, career_page_highlight: false, contact_hr_name: "", contact_hr_email: ""
  });
  ...
  const handleSubmit = async (submitStatus = "Published") => {
    ...
    try {
      ...
      await apiClient.put(`/job/${id}`, payload);
  ...
  if (loadingJob) return <div className="text-center py-20 text-gray-500">Loading job details...</div>;
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12 px-6">
      ...
      <div className="flex justify-between items-end mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Edit Enterprise Job</h1>
          <p className="text-gray-500 mt-1">Update the details for {form.title}.</p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="border-t pt-6">
              ...
              <div className="mb-6">
                ...
                <select 
                  value={form.application_form_config?.jobCategory || "Experienced"} 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {form.application_form_config?.sections && Object.keys(form.application_form_config.sections).map(section => (
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {form.application_form_config?.fields && Object.keys(form.application_form_config.fields)
                      .filter(field => {
