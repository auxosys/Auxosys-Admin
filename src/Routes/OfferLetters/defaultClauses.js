export const buildCompensationClauseContent = (offerType, ctcAmount, currency = "INR") => {
  ...
  if (offerType === "Internship") {
    ...
    const compText = isPaid
      ? `You shall be entitled to an annual CTC of <b>${currency} ${ctcAmount}</b>, payable in monthly installments in accordance with the Company's standard payroll cycle, subject to satisfactory performance and completion of assigned responsibilities.`
      : `You shall be entitled to an annual CTC of <b>${currency} 0</b>, subject to satisfactory performance and completion of assigned responsibilities.`;

    return `<p><ul><li><b>Compensation:</b> ${compText}</li><li><b>Bonus/Incentives:</b> You may be eligible for additional performance-based bonuses or incentives, which will be solely determined by the Company based on your contribution, strategy, and overall impact. These payments, if any, are discretionary and not guaranteed.</li><li><b>Payment Cycle:</b> Salary shall be credited to your designated bank account in accordance with the Company's standard payroll cycle, subject to applicable attendance records and statutory deductions.</li><li><b>Deductions:</b> The Company reserves the right to make statutory deductions (including TDS, PF, ESI where applicable) and deductions for unauthorised absence without approved leave in accordance with Company policies and applicable law.</li><li><b>Tax Implications:</b> All payments are subject to applicable statutory deductions as per prevailing tax laws of the Republic of India. You are responsible for fulfilling your individual income tax obligations.</li><li><b>Final Settlement:</b> Upon separation, and only after fulfilling all exit formalities, including return of assets and documentation, the Company will process your final settlement, including pending salary, approved bonuses, and Relieving / Experience Letters in accordance with Company policy and applicable law.</li></ul></p>`;
  }
};
...
export const FULL_TIME_CLAUSES = [
  ...
  },
  {
    ...
    content: `<p>Your employment with Auxosys Technologies Pvt. Ltd. ("the Company") shall be on a full-time basis, subject to the terms and conditions outlined in this Offer Letter and applicable Company policies.</p><p>During the course of your employment, you will be assigned to work closely with designated internal teams, project managers, and key personnel, contributing actively to ongoing projects, tasks, and operational functions. You are expected to perform your duties diligently, following assigned responsibilities with professionalism and due care.</p><p>Your role requires strict adherence to all Company policies, including confidentiality, data protection, intellectual property rights, and professional discipline. You shall exercise the highest level of integrity in handling sensitive and proprietary information and will be responsible for safeguarding all confidential materials and data entrusted to you.</p><p>The Company reserves the right to modify your assignments, roles, or responsibilities as per business needs and project requirements. Your continued employment is contingent upon satisfactory performance and compliance with all applicable Company policies and ethical standards.</p>`,
    isActive: true,
    required: true
  },
  {
    id: "probation_and_confirmation",
    title: "Probation Period and Confirmation",
    content: `<p><b>Probation Period:</b> You shall initially be on probation for a period of six (6) months from your date of joining. The Company reserves the right to extend the probation period if your performance, conduct, or attendance requires further evaluation.</p><p><b>Confirmation:</b> Upon successful completion of the probation period, your employment will be confirmed in writing by the Company, subject to satisfactory performance and management approval. Until formal confirmation is issued in writing, you shall continue to be on probation.</p><p><b>Notice Period During Probation vs Confirmation:</b> During the probation period, either party may terminate employment by giving fifteen (15) calendar days' written notice or salary in lieu thereof. Upon confirmation, the mandatory notice period required by either party shall be thirty (30) calendar days or as per prevailing Company policy.</p>`,
    isActive: true,
    required: true
  },
  {
    ...
    content: `<p>At AUXOSYS, we hold professionalism and ethical conduct as fundamental pillars that uphold our corporate culture and foster a respectful and productive work environment. As an employee, you are expected to consistently demonstrate the highest standards of professional behaviour throughout your employment with the Company. This includes, but is not limited to, the following key expectations:</p><ul><li><b>Punctuality and Attendance:</b> You are required to be punctual in reporting to work or attending virtual meetings and complete assigned work within stipulated time frames. Regular attendance and adherence to scheduled work hours reflect your commitment and respect for the organisation.</li><li><b>Discipline:</b> Maintain self-discipline at all times in your conduct and work ethic. This encompasses following all Company policies, refraining from any form of misconduct, and abiding by directions issued by supervisors or management personnel.</li><li><b>Mutual Respect and Teamwork:</b> Foster an environment of mutual respect, cooperation, and collaboration with colleagues, supervisors, and clients. Discrimination, bullying, harassment (verbal, physical, sexual, or psychological), or disrespectful behaviour is strictly prohibited.</li><li><b>Adherence to Instructions:</b> Diligently follow all lawful instructions and guidelines provided by authorised personnel.</li><li><b>Responsiveness and Communication:</b> Maintain prompt, clear, and professional communication both internally and externally.</li><li><b>Integrity and Honesty:</b> Demonstrate honesty and transparency in all your dealings. Any form of dishonesty or misrepresentation will be treated as a serious breach of trust.</li><li><b>Confidentiality:</b> Safeguard all confidential and proprietary information of the Company, clients, and partners.</li><li><b>Use of Company Resources:</b> Utilise all Company resources responsibly and solely for official business purposes.</li></ul><p><b>Disciplinary Actions</b><br>The Company reserves the right to take disciplinary action against any employee found guilty of misconduct, including formal written warnings, suspension, or termination of employment in accordance with Company policies and applicable law.</p>`,
    isActive: true,
    required: true
  },
  {
    ...
    content: `<p>As a valued member of the AUXOSYS team, you are entrusted with access to sensitive and proprietary information essential to the Company's operations, competitive standing, and client relationships. Upholding strict confidentiality and complying with the Company's Code of Conduct are fundamental responsibilities throughout your employment tenure.</p><p><b>Confidential Information Defined</b><br>Confidential information includes, but is not limited to, proprietary business data, financial records, marketing strategies, project plans, product designs, software code, technical documentation, client and vendor details, contracts, pricing, internal reports, and employee records.</p><p><b>Non-Disclosure and Non-Use Obligations</b><br>You agree to:<ul><li>Maintain the strict confidentiality of all such information during and after your employment with AUXOSYS.</li><li>Refrain from disclosing, sharing, publishing, or disseminating confidential information to any third party without prior written authorisation from the Company.</li><li>Not use confidential information for personal gain, competitive advantage, or any purpose unrelated to your duties at the Company.</li><li>Ensure that all physical and electronic materials containing confidential information are securely stored.</li></ul></p><p><b>Return of Company Property</b><br>Upon separation or conclusion of your employment, you shall immediately return all documents, materials, electronic devices, and property belonging to the Company without retaining any copies.</p>`,
    isActive: true,
    required: true
  },
  {
    ...
    content: `<p>As part of your employment with AUXOSYS ("the Company"), you may be granted access to various digital and physical assets essential to the performance of your duties, including computer systems, software, databases, proprietary tools, communication platforms, physical equipment, and documentation.</p><p><b>Authorised Use of Company Assets</b><ul><li>Access to Company assets is extended solely for fulfilling your assigned employment responsibilities.</li><li>Personal use of Company systems, software, or physical resources is prohibited unless specifically authorised in writing by management.</li><li>You are required to follow all IT and data security protocols established by the Company.</li></ul></p><p><b>Return of Assets</b><ul><li>Upon termination or separation from employment, you are required to return all Company-issued physical and digital assets in good working condition.</li><li>All digital access credentials and permissions will be revoked upon separation.</li></ul>`,
    isActive: true,
    required: true
  },
  {
    ...
    content: `<p><b>Acceptance of Offer</b><br>Upon receiving this offer, you are required to formally acknowledge and accept the terms and conditions by signing and returning a copy of this letter within the stipulated acceptance period. Acceptance of this offer constitutes your commitment to join AUXOSYS ("the Company") on the agreed start date.</p><p><b>Obligations Upon Acceptance</b><br>Once accepted:<ul><li>You are required to report for duty on the agreed start date.</li><li>You must maintain regular communication with the Company during the onboarding process.</li></ul></p><p><b>Non-Compliance</b><br>Failure to join on the agreed start date without prior written approval or deliberate avoidance of communication will result in the immediate revocation of the employment offer. The Company reserves the right to determine future re-employment eligibility based on the circumstances.</p>`,
    isActive: true,
    required: true
  },
  {
    ...
    content: `<p><b>Voluntary Resignation & Notice Period</b><br>Should you decide to voluntarily resign from your employment with the Company, you are required to submit a formal written resignation to your reporting manager and the Human Resources department.</p><p><b>Applicable Notice Period</b><ul><li>During probation: 15 calendar days' written notice.</li><li>After confirmation: 30 calendar days' written notice.</li><li>The Company reserves the right to waive or shorten the notice period or accept salary in lieu of notice, depending on operational requirements.</li></ul></p><p><b>Exit Formalities and Handover</b><ul><li>You are required to complete a thorough handover of your duties, responsibilities, and ongoing projects before your last working day.</li><li>Failure to complete required exit and handover formalities or return Company assets may delay administrative closure and the issuance of applicable employment documents (such as Relieving Letter and Experience Certificate), subject to applicable law.</li><li>Final settlement will be processed in accordance with Company policy and applicable statutory requirements.</li></ul></p>`,
    isActive: true,
    required: true
  },
  {
    ...
    content: `<p>Employees shall not undertake any external employment, business activity, consultancy, or engagement that creates a conflict of interest, competes with the Company's business, compromises confidential information, or materially interferes with their employment responsibilities, without prior written approval from the Company.</p><p>You acknowledge and agree that your full and undivided professional commitment is required during your employment tenure with AUXOSYS.</p><p><b>Consequences of Violation:</b><br>Any violation of this exclusivity obligation will be considered misconduct and may subject the Employee to disciplinary action, including termination of employment in accordance with Company policies and applicable law.</p>`,
    isActive: true,
    required: true
  },
  {
    id: "false_allegations",
    title: "False Allegations and Defamation",
    content: `<p>The Employee shall not knowingly make false, defamatory, or malicious statements intended to harm the reputation of the Company, its employees, clients, or stakeholders. Nothing in this clause restricts the Employee from exercising rights available under applicable law or reporting genuine concerns through appropriate channels.</p><p><b>Scope of Prohibited Conduct</b><br>Employees are strictly prohibited from making or circulating statements that are:<ul><li>Factually incorrect, misleading, or unsubstantiated;</li><li>Intentionally harmful or designed to malign the Company, its management, employees, clients, or partners;</li><li>Disseminated publicly through social media platforms, online forums, blogs, or public media outlets.</li></ul></p><p><b>Disciplinary Action</b><br>Any intentional defamation damaging the Company's reputation will be treated as gross misconduct and may lead to disciplinary action, including termination of employment and legal remedies permitted under applicable law.</p>`,
    isActive: true,
    required: true
  },
  {
    ...
    content: `<p><b>Periodic Performance Evaluation</b><br>As an employee of AUXOSYS ("the Company"), your work performance, conduct, and overall contribution will be subject to regular evaluation by your reporting manager and the Human Resources department. Performance gaps will be communicated to you, and where appropriate, a Performance Improvement Plan (PIP) may be initiated to support your development.</p><p><b>Grounds for Termination</b><br>Subject to applicable law and Company policy, employment may be terminated under circumstances including:<ul><li><b>Unsatisfactory Performance:</b> Persistent failure to meet performance standards despite feedback or PIP completion.</li><li><b>Breach of Company Policies:</b> Gross misconduct, breach of confidentiality, harassment, or violation of security and operational policies.</li><li><b>Unauthorised Absence:</b> Unapproved absenteeism beyond limits permitted by Company leave policy.</li></ul></p><p><b>Final Dues and Handover</b><br>Upon termination of employment, final settlement and issuance of employment documents (Relieving Letter and Experience Certificate) will be processed after completion of exit formalities and asset returns in accordance with Company policy and applicable law.</p>`,
    isActive: true,
    required: true
  },
  {
    ...
    content: `<p><b>Provisional Nature of Offer</b><br>Your employment with AUXOSYS ("the Company") is provisional and subject to satisfactory verification of documents submitted by you and completion of background checks.</p><p><b>Mandatory Documentation</b><ul><li><b>Identity Proof:</b> Aadhaar Card, PAN Card, Passport, or Driving License.</li><li><b>Academic Credentials:</b> Degree certificates, mark sheets, and transcripts.</li><li><b>Previous Employment Records:</b> Experience letters, relieving letters, and salary slips from previous employers (if applicable).</li></ul></p><p><b>Consequences of Misrepresentation</b><br>Submission of forged, altered, or misleading credentials will result in immediate cancellation of the offer or termination of employment without notice, in accordance with applicable law.</p>`,
    isActive: true,
    required: true
  },
  {
    ...
    content: `<p>At any point during your employment, you may be subject to drug or substance-abuse tests as deemed necessary by the Company or client requirements in accordance with Company policy. Failure to undergo such tests or failure to pass them will lead to disciplinary action, including suspension or termination of services.</p>`,
    isActive: true,
    required: true
  },
  {
    ...
    content: `<p>This Leave Policy forms an integral part of the Employment Agreement with AUXOSYS. All employees are required to adhere strictly to the provisions laid out herein.</p><p><b>1. Types of Leave</b><ul><li><b>Casual Leave (CL):</b> Limited to 6 days per calendar year.</li><li><b>Sick Leave (SL):</b> Limited to 12 days per year.</li><li><b>Earned Leave / Privilege Leave (EL/PL):</b> Accrued based on tenure and available after completion of a specified period of employment.</li><li><b>Compensatory Off (Comp Off):</b> Granted for approved overtime or holiday work.</li><li><b>Leave Without Pay (LWP):</b> Granted when paid leave balances are exhausted, subject to management approval.</li></ul></p>`,
    isActive: true,
    required: true
  },
  {
  ...
  },
  {
    ...
    content: `<p><b>Return of Company Property</b><br>Upon termination of employment, whether voluntary or involuntary, you are required to return all Company property in your possession, including physical equipment (laptops, mobile devices, access cards), confidential documents, and electronic storage media.</p><p><b>Handover Process</b><br>You are obligated to complete a formal handover of all ongoing projects, deliverables, and operational responsibilities to your designated team members or reporting manager.</p><p><b>Non-Solicitation Obligations</b><br>For a period of six (6) months following separation, you shall not directly or indirectly solicit any of the Company's current clients, vendors, or employees for competitive or personal business purposes.</p><p><b>Administrative Closure</b><br>Failure to complete required exit and handover formalities may delay administrative closure and issuance of applicable employment documents (such as Relieving Letter and Experience Certificate), subject to applicable law. Final settlement shall be processed in accordance with Company policy and applicable law.</p>`,
    isActive: true,
    required: true
  },
  {
  ...
  },
  {
    ...
    content: `<p>Checklist of exit formalities including return of assets, project handover, IT/HR/Finance clearance, and issuance of Relieving and Experience Letters.</p>`,
    isActive: true,
    required: true
  }
];
